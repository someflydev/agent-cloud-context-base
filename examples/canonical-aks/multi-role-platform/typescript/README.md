# AKS Multi-Role Platform (typescript)

This accb expansion demonstrates a Kubernetes multi-role platform for subscription-event-hydrator in TypeScript: billing API, Service Bus worker, invoice rebuild job, month-close cron.
