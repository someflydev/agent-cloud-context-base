# S3 Trigger Image Moderation - Go
...
- Terraform state: `accb/canonical-aws-lambda/s3-trigger-image-moderation/go/dev.tfstate` and `.../test.tfstate`
...
```bash
bash examples/canonical-aws-lambda/s3-trigger-image-moderation/go/tests/verify.sh
```
