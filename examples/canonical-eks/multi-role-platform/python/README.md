# EKS Multi-Role Platform (python)

This accb seed demonstrates a Kubernetes multi-role platform for stream-enrichment: ingest API, Kafka lag workers, replay job, scheduled S3 export.
