...
through the Pulumi Automation API, runs assertions, and destroys the stack. It
is skipped unless `ACCB_RUN_REAL_CLOUD=1` is set and provider credentials are
