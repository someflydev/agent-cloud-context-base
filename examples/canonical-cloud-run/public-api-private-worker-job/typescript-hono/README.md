...
- Resource naming: `accb-${environment}-cloudrun-public-worker-ts-*`.
...
```bash
bash examples/canonical-cloud-run/public-api-private-worker-job/typescript-hono/tests/verify.sh
```
