...
| --- | --- | --- | --- | --- | --- | --- |
| aws | managed_container | app-runner | python-fastapi | Supported | [canonical-app-runner/public-api-with-vpc-connector](../examples/canonical-app-runner/public-api-with-vpc-connector/python-fastapi/) |  |
...
| aws | function | aws-lambda | python | Supported | [canonical-aws-lambda/s3-trigger-image-moderation](../examples/canonical-aws-lambda/s3-trigger-image-moderation/python/) |  |
| aws | function | aws-lambda | typescript | Supported | [canonical-aws-lambda/apigw-stripe-webhook](../examples/canonical-aws-lambda/apigw-stripe-webhook/typescript/) |  |
| aws | function | aws-lambda | go | Supported | [canonical-aws-lambda/sqs-document-translation](../examples/canonical-aws-lambda/sqs-document-translation/go/) |  |
...
| aws | k8s | eks | python | Supported | [canonical-eks/multi-role-platform](../examples/canonical-eks/multi-role-platform/python/) |  |
| aws | k8s | eks | go | Supported | [canonical-eks/multi-role-platform](../examples/canonical-eks/multi-role-platform/go/) |  |
| gcp | managed_container | cloud-run | python-fastapi | Supported | [canonical-cloud-run/public-api-private-worker-job](../examples/canonical-cloud-run/public-api-private-worker-job/python-fastapi/) |  |
...
| gcp | managed_container | cloud-run | go-echo | Supported | [canonical-cloud-run/public-api-private-worker-job](../examples/canonical-cloud-run/public-api-private-worker-job/go-echo/) |  |
...
| gcp | function | gcp-cloud-functions | python | Supported | [canonical-gcp-functions/gcs-trigger-ocr-to-firestore](../examples/canonical-gcp-functions/gcs-trigger-ocr-to-firestore/python/) |  |
...
| gcp | k8s | gke | python | Supported | [canonical-gke/multi-role-platform](../examples/canonical-gke/multi-role-platform/python/) |  |
| gcp | k8s | gke | go | Supported | [canonical-gke/multi-role-platform](../examples/canonical-gke/multi-role-platform/go/) |  |
| azure | managed_container | container-apps | python-fastapi | Supported | [canonical-container-apps/public-api-private-worker-jobs](../examples/canonical-container-apps/public-api-private-worker-jobs/python-fastapi/) |  |
| azure | managed_container | container-apps | dotnet-aspnet | Supported | [canonical-container-apps/public-api-private-worker-jobs](../examples/canonical-container-apps/public-api-private-worker-jobs/dotnet-aspnet/) |  |
...
| azure | function | azure-functions | python | Supported | [canonical-azure-functions/blob-trigger-receipt-ocr](../examples/canonical-azure-functions/blob-trigger-receipt-ocr/python/) |  |
...
| azure | k8s | aks | dotnet | Supported | [canonical-aks/multi-role-platform](../examples/canonical-aks/multi-role-platform/dotnet/) |  |
